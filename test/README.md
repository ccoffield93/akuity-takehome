This directory provides a simple functional test to exhibit the behavior of the NamespaceClass custom resource and its controller. Each step waits for the user to hit Enter to proceed to the next step, so that another terminal may be used for deeper investigation into cluster state as needed.
...
11. Modify NSC1 to add a ConfigMap resource. 
12. Retrieve NS1 resources to see the ConfigMap has been added. 
